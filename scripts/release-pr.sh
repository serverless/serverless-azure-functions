...
BASEDIR=$(dirname "$0")
PROMPT=$(echo -e "This will create changes to open a release PR for Serverless Azure Functions v${NEW_VERSION}?\nNOTE: a clean working git directory is required.\nDo you want to continue? [Y/n] ")
...
then
    ...
    git tag -a ${NEW_VERSION} -m "Serverless Azure Functions v${NEW_VERSION}"
