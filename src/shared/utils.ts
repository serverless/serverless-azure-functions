...
export function getBindingUserSettingsMetaData(azureSettings, bindingType, bindingTypeIndex, bindingDisplayNames) {
...
export function getEntryPointAndHandlerPath(handler) {
...
export function getHttpOutBinding(bindingUserSettings) {
  const binding = {};
...
export function getBinding(bindingType, bindingSettings, bindingUserSettings) {
  const binding = {};
